    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            switch (random.nextInt(0, 4)) {
                case 0 -> brightSide.add(new Peasant(getName()));
                case 1 -> brightSide.add(new Pikeman(getName()));
                case 2 -> brightSide.add(new Crossbowman(getName()));
                case 3 -> brightSide.add(new Monk(getName()));
            }

        }
        for (int i = 0; i < 10; i++) {
            switch (random.nextInt(0, 4)) {
                case 0 -> darkSide.add(new Peasant(getName()));
                case 1 -> darkSide.add(new Rogue(getName()));
                case 2 -> darkSide.add(new Sharpshooter(getName()));
                case 3 -> darkSide.add(new Enchanter(getName()));
            }
